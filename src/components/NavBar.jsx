...
import { CircularProgressbar } from 'react-circular-progressbar'; export default function NavBar() {
    return (
        <div className='lg:flex lg:justify-between lg:items-center text-center p-4  space-y-4' >
            ...
            <div className='text-white flex gap-5 justify-center lg:text-md text-sm'>
                <div className='flex bg-gray-700 rounded-lg w-auto p-4 h-9 justify-center items-center cursor-pointer'>
                    <button>INR</button>
            ...
            <div className='gap-5 text-white flex gap-2 items-center  justify-center'>
                ...
                <div className='flex bg-teal-400 rounded-lg w-auto p-4 h-9 justify-center items-center'>
